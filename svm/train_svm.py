...
class train_svm():
    ...
    def svm_training(self):
        ...
        tuned_parameters = [{'kernel': ['rbf'], 'gamma': np.logspace(-1, 2, 4, endpoint = True), 
                             'C': np.logspace(-1, 2, 4, endpoint = True)},
                             {'kernel': ['linear'],'C': np.logspace(-1, 2, 4, endpoint = True)},
                             {'kernel': ['poly'], 'C': np.logspace(-1, 2, 4, endpoint = True), 'degree': [1, 2, 3], 'gamma': np.logspace(-1, 2, 4, endpoint = True)}]
        ...
        model_save_path = '/home/hts/hts2019/openpose/svm/train_madel.m'
